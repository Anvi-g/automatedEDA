...
async def main():
    ...
    try:
        ...
        print("📊 Your logistic regression dataset is ready!")
        
        print("\n📁 Output Files (data/processed/ only):")
        output_files = [
            "data/processed/logistic_ready_train.csv",
            "data/processed/logistic_ready_test.csv",
        ...
        print(f"\n📊 Files Created: {success_count}/{len(output_files)}")
        if success_count == 3:
            print("✅ All files successfully created in data/processed/ directory!")
        else:
            print("⚠️  Some files are missing. Check agent execution logs above.")
